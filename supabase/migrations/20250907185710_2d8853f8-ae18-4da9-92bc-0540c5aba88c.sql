...
-- Drop existing views that have SECURITY DEFINER property
DROP VIEW IF EXISTS public.v_event_profit;
DROP VIEW IF EXISTS public.v_popular_dishes;

-- Recreate v_event_profit view without SECURITY DEFINER
...
-- Recreate v_popular_dishes view without SECURITY DEFINER
